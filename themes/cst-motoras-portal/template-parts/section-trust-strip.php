...
$items = [
    [
        ...
        'label' => __( 'Certificado Digital', 'cst-motoras' ),
    ],
    [
        ...
        'label' => __( '100% En Línea', 'cst-motoras' ),
    ],
    [
        ...
        'label' => __( 'A Tu Ritmo', 'cst-motoras' ),
    ],
    [
        ...
        'label' => __( 'Aprobado CST', 'cst-motoras' ),
    ],
];
?>
<section class="cst-trust-strip" role="region" aria-label="<?php esc_attr_e( 'Beneficios del curso', 'cst-motoras' ); ?>">
    <div class="cst-container">
        <ul class="cst-trust-strip__list">
            <?php foreach ( $items as $item ) : ?>
                <li class="cst-trust-strip__item">
                    <span class="cst-trust-strip__icon"><?php echo $item['icon']; ?></span>
