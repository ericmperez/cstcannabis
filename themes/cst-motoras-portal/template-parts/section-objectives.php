...
$objectives = [
    [
        ...
        'title' => __( 'Fundamentos del cannabis medicinal', 'cst-motoras' ),
        'desc'  => __( 'Proveer información basada en evidencia sobre el uso responsable del cannabis medicinal y su impacto en la seguridad vial.', 'cst-motoras' ),
    ],
    [
        ...
        'title' => __( 'Impacto en la conducción', 'cst-motoras' ),
        'desc'  => __( 'Crear conciencia sobre los efectos del cannabis en la conducción y promover alternativas seguras de transporte.', 'cst-motoras' ),
    ],
    [
        ...
        'title' => __( 'Datos y estadísticas', 'cst-motoras' ),
        'desc'  => __( 'Recopilar y publicar datos estadísticos actualizados que apoyen políticas públicas informadas.', 'cst-motoras' ),
    ],
];
?>
...
<section class="cst-section cst-section--objectives" id="objetivos"
    ...
    <div class="cst-container">
        <?php cst_section_heading(
            ...
            __( 'Tres módulos diseñados para que domines los fundamentos de la seguridad vial y el cannabis medicinal.', 'cst-motoras' )
        ); ?>
