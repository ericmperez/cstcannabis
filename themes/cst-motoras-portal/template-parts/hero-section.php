...
<section class="cst-hero <?php echo esc_attr( $class ); ?>"<?php echo $style; ?>
         role="region" aria-label="<?php esc_attr_e( 'Sección principal', 'cst-motoras' ); ?>">
    <div class="cst-hero__overlay" aria-hidden="true"></div>

    <!-- Floating decorative shapes -->
    <svg class="cst-hero__float cst-hero__float--1" width="120" height="120" viewBox="0 0 120 120" aria-hidden="true"><circle cx="60" cy="60" r="60" fill="rgba(62,100,222,0.12)"/></svg>
    ...
    <div class="cst-container">
        <div class="cst-hero__content">
            ...
            <?php if ( ! empty( $args['trust_badges'] ) ) : ?>
                <div class="cst-hero__badges" aria-label="<?php esc_attr_e( 'Beneficios del curso', 'cst-motoras' ); ?>">
