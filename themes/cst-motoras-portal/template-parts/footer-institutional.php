...
<footer class="cst-institutional-footer" role="contentinfo">
    <div class="cst-container">
        ...
        <div class="cst-institutional-footer__grid">
                ...
                <div class="cst-institutional-footer__branding">
                    ...
                    if ( $custom_logo_id ) :
                        echo wp_get_attachment_image( $custom_logo_id, 'thumbnail', false, [
                            ...
                            'alt'   => esc_attr__( 'Sello CST', 'cst-motoras' ),
                        ] );
                    endif;
                    ?>
                    <p class="cst-institutional-footer__agency">
                        <?php esc_html_e( 'Comisión para la Seguridad en el Tránsito de Puerto Rico', 'cst-motoras' ); ?>
                    </p>
                </div>
                <div class="cst-institutional-footer__oig">
                    <a href="https://www.oig.pr.gov/" target="_blank" rel="noopener noreferrer"
                       aria-label="<?php esc_attr_e( 'Oficina del Inspector General', 'cst-motoras' ); ?>">
                        <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/oig-logo.svg' ); ?>"
                             alt="<?php esc_attr_e( 'Oficina del Inspector General', 'cst-motoras' ); ?>"
            ...
            <div class="cst-institutional-footer__col">
                ...
                <?php else : ?>
                    <h4 class="cst-footer-widget__title"><?php esc_html_e( 'Contenido', 'cst-motoras' ); ?></h4>
                    <?php
                    wp_nav_menu( [
            ...
            <div class="cst-institutional-footer__col">
                ...
                <?php else : ?>
                    <h4 class="cst-footer-widget__title"><?php esc_html_e( 'Servicios', 'cst-motoras' ); ?></h4>
            ...
            <div class="cst-institutional-footer__col">
                <h4 class="cst-footer-widget__title"><?php esc_html_e( 'Síguenos', 'cst-motoras' ); ?></h4>
                    ...
                    ?>
                        <li>
                            <a href="mailto:<?php echo esc_attr( $email_link ); ?>"
                               aria-label="<?php esc_attr_e( 'Correo electrónico', 'cst-motoras' ); ?>">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <div class="cst-institutional-footer__col">
                <?php if ( is_active_sidebar( 'footer-3' ) && is_active_sidebar( 'footer-4' ) ) : ?>
                    <?php dynamic_sidebar( 'footer-3' ); ?>
                <?php else : ?>
                    <h4 class="cst-footer-widget__title"><?php esc_html_e( 'Contactos', 'cst-motoras' ); ?></h4>
        ...
        <div class="cst-institutional-footer__compliance">
            <p>
                <?php esc_html_e( 'La Comisión para la Seguridad en el Tránsito es un patrono con igualdad de oportunidades en el empleo. No se discrimina por razón de raza, color, género, nacimiento, origen o condición social, ni por ideas políticas o religiosas, edad, orientación sexual o identidad de género.', 'cst-motoras' ); ?>
            </p>
            <p>
                <?php esc_html_e( 'Somos un patrono con un programa de acción afirmativa que cumple con los reglamentos gubernamentales.', 'cst-motoras' ); ?>
            </p>
        </div>
        ...
        <div class="cst-institutional-footer__legal">
            ...
            wp_nav_menu( [
                ...
                'container_aria_label' => esc_attr__( 'Enlaces legales', 'cst-motoras' ),
        ...
        <div class="cst-institutional-footer__copyright">
            <p>
                ...
                <?php esc_html_e( 'Comisión para la Seguridad en el Tránsito de Puerto Rico. Todos los derechos reservados.', 'cst-motoras' ); ?>
            </p>
        </div>
    ...
    <!-- Back to top -->
    <button class="cst-back-to-top" aria-label="<?php esc_attr_e( 'Volver al inicio', 'cst-motoras' ); ?>" type="button">
