...
$callouts = [
    [
        ...
        'title' => __( 'Expertos en la materia', 'cst-motoras' ),
        'desc'  => __( 'Contenido desarrollado por especialistas en seguridad vial con base en estándares locales y federales.', 'cst-motoras' ),
    ],
    [
        ...
        'title' => __( 'Alianzas confiables', 'cst-motoras' ),
        'desc'  => __( 'Colaboración entre la CST, DTOP y agencias gubernamentales para promover una cultura de conducción responsable.', 'cst-motoras' ),
    ],
    [
        ...
        'title' => __( 'Educación preventiva', 'cst-motoras' ),
        'desc'  => __( 'Formación obligatoria por ley para garantizar que todo motociclista posea los conocimientos fundamentales antes de salir a la vía.', 'cst-motoras' ),
    ],
];
?>

<section class="cst-section cst-section--course-impact" role="region"
         aria-label="<?php esc_attr_e( 'Impacto del curso', 'cst-motoras' ); ?>">
    <div class="cst-container">

        <div class="cst-course-impact__grid">
            <div class="cst-course-impact__text">
                <h2 class="cst-course-impact__title">
                    <?php esc_html_e( 'Reduciendo Riesgos y Salvando Vidas en las Carreteras de Puerto Rico', 'cst-motoras' ); ?>
                </h2>
                <p class="cst-course-impact__desc">
                    <?php esc_html_e( 'Puerto Rico enfrenta un reto crítico en seguridad vial para motociclistas. Este módulo obligatorio asegura que todo operador posea los conocimientos fundamentales sobre conducción segura, equipo de protección y respuesta ante emergencias.', 'cst-motoras' ); ?>
                </p>
            </div>
            <div class="cst-course-impact__stat-box">
                <span class="cst-course-impact__stat-number" aria-hidden="true">36%</span>
                <p class="cst-course-impact__stat-label">
                    <?php esc_html_e( 'de los motociclistas en accidentes fatales no tenían licencia válida', 'cst-motoras' ); ?>
                </p>
            </div>
        </div>
