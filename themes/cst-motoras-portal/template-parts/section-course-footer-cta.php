 ...
 *
 * Registration form, certificate mockup, contact info, and legal disclaimer.
...
<section class="cst-section cst-section--course-footer-cta" id="registro" role="region"
         aria-label="<?php esc_attr_e( 'Registro al curso', 'cst-motoras' ); ?>">
    <div class="cst-container">

        <div class="cst-course-footer-cta__header">
            <h2 class="cst-course-footer-cta__title">
                <?php esc_html_e( 'Módulo en Conducción Segura para Motociclistas y Four Tracks', 'cst-motoras' ); ?>
            </h2>
            <p class="cst-course-footer-cta__subtitle">
                <?php esc_html_e( 'Recurso educativo gratuito de la CST — Requisito de Ley 107', 'cst-motoras' ); ?>
            </p>
        </div>
        ...
        <div class="cst-course-footer-cta__grid">
            ...
            <div class="cst-course-footer-cta__form cst-contact-form" tabindex="-1"
                 data-redirect-url="https://cursomotoras.willai.info/courses/modulo-conduccion-segura-para-motociclistas/">
                <h3><?php esc_html_e( 'Regístrate ahora', 'cst-motoras' ); ?></h3>
                <?php
                while ( have_posts() ) :
                    the_post();
                    the_content();
            ...
            <div class="cst-course-footer-cta__info">
                ...
                <div class="cst-certificate-mockup" aria-label="<?php esc_attr_e( 'Ejemplo de certificado digital', 'cst-motoras' ); ?>">
                    <div class="cst-certificate-mockup__card">
                        <div class="cst-certificate-mockup__border">
                            <div class="cst-certificate-mockup__seal">
                                <img src="<?php echo esc_url( CST_MOTORAS_URI . '/assets/images/cst-logo.svg' ); ?>"
                                     alt="" width="60" height="20" aria-hidden="true" />
                            </div>
                            <p class="cst-certificate-mockup__label"><?php esc_html_e( 'Certificado de Aprobación', 'cst-motoras' ); ?></p>
                            <p class="cst-certificate-mockup__course"><?php esc_html_e( 'Conducción Segura para Motociclistas y Four Tracks', 'cst-motoras' ); ?></p>
                            <p class="cst-certificate-mockup__name"><?php esc_html_e( 'Juan del Pueblo', 'cst-motoras' ); ?></p>
                            <div class="cst-certificate-mockup__details">
                                <span><?php esc_html_e( 'Fecha: DD/MM/AAAA', 'cst-motoras' ); ?></span>
                                <span><?php esc_html_e( 'Válido: 90 días', 'cst-motoras' ); ?></span>
                            </div>
                            <div class="cst-certificate-mockup__qr" aria-hidden="true">
                                ...
                                <span class="cst-certificate-mockup__qr-label"><?php esc_html_e( 'Código QR verificable', 'cst-motoras' ); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cst-course-footer-cta__disclaimer">
                    <p>
                        <?php esc_html_e( 'Este módulo es un recurso educativo obligatorio ofrecido por la Comisión para la Seguridad en el Tránsito (CST) según la Ley 107. El contenido es de carácter informativo y educativo. Consulte a un profesional para orientación específica.', 'cst-motoras' ); ?>
                    </p>
                </div>
