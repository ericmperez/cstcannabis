    ...
    <section class="cst-section cst-section--legal">
        <div class="cst-container">
            <div class="cst-legal-layout">
                ...
                <aside class="cst-legal-toc" aria-label="<?php esc_attr_e( 'Tabla de contenido', 'cst-motoras' ); ?>">
                    <h2 class="cst-legal-toc__title"><?php esc_html_e( 'Contenido', 'cst-motoras' ); ?></h2>
                    <nav id="cst-toc-nav">
                    ...
                    <div class="cst-legal-meta">
                        <p class="cst-legal-meta__updated">
                            ...
                            printf(
                                ...
                                esc_html__( 'Última actualización: %s', 'cst-motoras' ),
