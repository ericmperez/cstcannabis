...
<main id="main-content" class="cst-main">
    ...
    cst_hero( [
        'title'    => get_the_title(),
        'subtitle' => __( 'Estamos para servirle. Contáctenos para preguntas, comentarios o asistencia.', 'cst-motoras' ),
        'class'    => 'cst-hero--page',
    ] );
    ?>
        ...
        <div class="cst-container">
            ...
            <div class="cst-contact-grid">
                ...
                <div class="cst-contact-info">
                    ...
                    <?php if ( $phone ) : ?>
                        <div class="cst-contact-card">
                            ...
                            <div class="cst-contact-card__body">
                                <h3><?php esc_html_e( 'Teléfono', 'cst-motoras' ); ?></h3>
                    ...
                    <?php if ( $email ) : ?>
                        <div class="cst-contact-card">
                            ...
                            <div class="cst-contact-card__body">
                                <h3><?php esc_html_e( 'Correo electrónico', 'cst-motoras' ); ?></h3>
                    ...
                    <?php if ( $address ) : ?>
                        <div class="cst-contact-card">
                            ...
                            <div class="cst-contact-card__body">
                                <h3><?php esc_html_e( 'Dirección', 'cst-motoras' ); ?></h3>
                    ...
                    <?php if ( $has_social ) : ?>
                        <div class="cst-contact-card">
                            ...
                            <div class="cst-contact-card__body">
                                <h3><?php esc_html_e( 'Redes sociales', 'cst-motoras' ); ?></h3>
                ...
                <div class="cst-contact-form">
                    <h2><?php esc_html_e( 'Envíenos un mensaje', 'cst-motoras' ); ?></h2>
                    <?php
