...
function cst_government_banner(): void {
    ?>
    <div class="cst-gov-banner" role="complementary" aria-label="<?php esc_attr_e( 'Banner del Gobierno de Puerto Rico', 'cst-motoras' ); ?>">
        <div class="cst-container">
            <div class="cst-gov-banner__inner">
                <p class="cst-gov-banner__text">
                    <img src="<?php echo esc_url( CST_MOTORAS_URI . '/assets/images/pr-flag-icon.svg' ); ?>"
                         alt="" width="20" height="14" class="cst-gov-banner__flag" aria-hidden="true">
                    <?php esc_html_e( 'Un sitio web oficial del Gobierno de Puerto Rico', 'cst-motoras' ); ?>
                    <button type="button" class="cst-gov-banner__toggle" aria-expanded="false"
                            aria-controls="cst-gov-banner-details">
                        <?php esc_html_e( 'Así es como usted puede verificarlo', 'cst-motoras' ); ?>
                ...
                <div id="cst-gov-banner-details" class="cst-gov-banner__details" hidden>
                    <div class="cst-gov-banner__columns">
                        <div class="cst-gov-banner__col">
                            <strong><?php esc_html_e( 'Los sitios web oficiales del Gobierno de Puerto Rico usan .pr.gov', 'cst-motoras' ); ?></strong>
                            <p><?php esc_html_e( 'Un sitio web .pr.gov pertenece a una organización oficial del Gobierno de Puerto Rico.', 'cst-motoras' ); ?></p>
                        </div>
                        <div class="cst-gov-banner__col">
                            <strong><?php esc_html_e( 'Los sitios web seguros de .pr.gov usan HTTPS', 'cst-motoras' ); ?></strong>
                            <p><?php esc_html_e( 'Un candado o https:// significa que usted se conectó de forma segura a un sitio web .pr.gov.', 'cst-motoras' ); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
function cst_breadcrumbs(): void {
    ...
    if ( function_exists( 'yoast_breadcrumb' ) ) {
        echo '<nav class="cst-breadcrumbs" aria-label="' . esc_attr__( 'Ruta de navegación', 'cst-motoras' ) . '">';
...
function cst_skip_link(): void {
    ...
    esc_html_e( 'Ir al contenido principal', 'cst-motoras' );
    echo '</a>';
}
