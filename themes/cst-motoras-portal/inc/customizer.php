...
add_action( 'customize_register', function ( WP_Customize_Manager $wp_customize ) {
    ...
    $wp_customize->add_section( 'cst_portal', [
        'title'    => __( 'Portal CST', 'cst-motoras' ),
        'priority' => 30,
    ] );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'cst_hero_image', [
        'label'   => __( 'Imagen del héroe', 'cst-motoras' ),
        'section' => 'cst_portal',
    ] ) );
    ...
    $wp_customize->add_control( 'cst_hero_title', [
        'label'   => __( 'Título del héroe (vacío = nombre del sitio)', 'cst-motoras' ),
        'section' => 'cst_portal',
        'type'    => 'text',
    ] );
    ...
    $wp_customize->add_control( 'cst_hero_subtitle', [
        'label'   => __( 'Subtítulo del héroe (vacío = descripción del sitio)', 'cst-motoras' ),
        'section' => 'cst_portal',
        'type'    => 'text',
    ] );
    ...
    $wp_customize->add_section( 'cst_contact', [
        'title'    => __( 'Información de contacto', 'cst-motoras' ),
        'priority' => 31,
    ] );

    $contact_fields = [
        'cst_phone'   => __( 'Teléfono', 'cst-motoras' ),
        'cst_email'   => __( 'Correo electrónico', 'cst-motoras' ),
        'cst_address' => __( 'Dirección', 'cst-motoras' ),
    ];
    ...
    $wp_customize->add_section( 'cst_social', [
        'title'    => __( 'Redes sociales', 'cst-motoras' ),
        'priority' => 32,
    ] );
