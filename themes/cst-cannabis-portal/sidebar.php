...
<aside id="right-sidebar" class="cst-sidebar widget-area" role="complementary"
    ...
    <div class="cst-sidebar__widget cst-sidebar__contact">
        ...
        <p>
            ...
            <?php $cst_sidebar_phone = get_theme_mod( 'cst_phone', '787-721-4142' ); ?>
            <a href="tel:<?php echo esc_attr( preg_replace( '/[^\d+]/', '', $cst_sidebar_phone ) ); ?>"><?php echo esc_html( $cst_sidebar_phone ); ?></a>
        </p>
    </div>
