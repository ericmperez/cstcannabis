...
<section class="cst-section cst-section--objectives" id="objetivos"
         aria-label="<?php esc_attr_e( 'Lo que aprenderás', 'cst-cannabis' ); ?>">
    <div class="cst-container">
        <?php cst_section_heading(
            __( 'Lo que aprenderás', 'cst-cannabis' ),
            __( 'Tres módulos diseñados para que domines los fundamentos de la seguridad vial y el cannabis medicinal.', 'cst-cannabis' )
        ); ?>
            ...
            <?php foreach ( $objectives as $index => $obj ) : ?>
                <div class="cst-objective-card" data-step="<?php echo esc_attr( $index + 1 ); ?>">
                    <div class="cst-objective-card__icon" aria-hidden="true">
                        <?php echo cst_kses_svg( $obj['icon'] ); ?>
                    </div>
